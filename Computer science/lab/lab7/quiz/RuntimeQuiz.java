...
public class RuntimeQuiz {
     ...
     */
    public static Runtime f1_omega_runtime =UNDEFINED;
    public static Runtime f1_o_runtime= UNDEFINED;
    public static Runtime f1_theta_runtime =LINEAR;
    ...
    public static Runtime f2_omega_runtime= UNDEFINED;
    public static Runtime f2_o_runtime= UNDEFINED;
    ...
    public static Runtime f3_omega_runtime= UNDEFINED;
    public static Runtime f3_o_runtime= UNDEFINED;
    ...
    public static Runtime f4_omega_runtime= UNDEFINED;
    public static Runtime f4_o_runtime= UNDEFINED;
    ...
    public static Runtime f5_omega_runtime=UNDEFINED;
    public static Runtime f5_o_runtime= UNDEFINED;
    ...
    public static Runtime f6_omega_runtime= UNDEFINED;
    public static Runtime f6_o_runtime=LINEAR;
    public static Runtime f6_theta_runtime= UNDEFINED
    ...
    public static Runtime f7_omega_runtime=LINEAR;
