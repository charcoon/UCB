...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Settings->Auto White",
            s -> _pendingCommands.offer("auto white"));
        addMenuButton("Settings->Manual White",
            s -> _pendingCommands.offer("manual white"));
        addMenuButton("Settings->Auto Black",
            s -> _pendingCommands.offer("auto black"));
        addMenuButton("Settings->Manual Black",
            s -> _pendingCommands.offer("manual black"));
